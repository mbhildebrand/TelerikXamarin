...
namespace TelerikXFApp1.Android
{
    [Activity(Label = "TelerikXFApp1.Android", Icon = "@drawable/icon", MainLauncher = true, ConfigurationChanges = ConfigChanges.ScreenSize | ConfigChanges.Orientation)]
